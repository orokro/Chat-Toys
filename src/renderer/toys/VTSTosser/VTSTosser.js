...
// components
import VTSTosserPage from './VTSTosserPage.vue';

// main export
export default class VTSTosser extends Toy {

	// static info
	static name = 'VTS Tosser';
	static slug = 'vtsTosser';
	static desc = 'Let viewers toss objects onto your stream, with VTubeStudio integration.';
	static optionsPageComponent = VTSTosserPage;
